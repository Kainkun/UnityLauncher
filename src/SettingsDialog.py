...
class SettingsDialog(QDialog):
    ...
    def __setupUI(self) -> None:
        ...
        self.projectFolderList = FolderListWidget(
            "Project Search Folders", config.getProjectFolders(), ui.ProjectFolderList)
        self.editorFolderList = FolderListWidget(
            "Editor Search Folders", config.getEditorFolders(), ui.EditorFolderList)
    ...
    def __setupEvents(self) -> None:
        ...
        def updateConfig(): return self.__updateConfig()
